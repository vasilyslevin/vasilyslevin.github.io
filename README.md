...
Plain HTML and CSS. No framework, no build step, no JavaScript dependencies.
The resume page prints cleanly via Ctrl+P / Cmd+P.

## Notes

- All date ranges use `&ndash;` (en-dash).
- No em-dashes anywhere in the site.
- Favicon: `assets/favicon.png` (upload separately).
